...
--- probabilistic predictions. A scoring rule `S(p, y)` is *proper* if
--- reporting one's true belief maximizes expected score, and *strictly
--- proper* if the maximum is unique.
---
--- ## Usage
---
--- ```lua
