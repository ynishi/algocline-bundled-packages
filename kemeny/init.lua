...
--- ranking that minimizes total Kendall tau distance to the inputs. The
--- Kemeny rule is the unique aggregation method satisfying Condorcet
--- consistency + neutrality + consistency (Young-Levenglick 1978). Also
--- exposes Borda count, Condorcet winner detection, and Kendall tau
--- distance as standalone helpers.
---
--- ## Usage
---
--- ```lua
