...
- [Defaults (Abdali 2025 §3 / Table 1)](#defaults-abdali-2025-3-table-1)
...
|---|---|---|---|
| `ctx.N` | number | optional | Max iterations (default: 5, (L) Abdali Table 1) |
...
| `ctx.tau_0` | number | optional | Initial temperature (default: 0.7, (L) Abdali Table 1) |
| `ctx.tau_a` | number | optional | Antithesis temperature (default: 0.5, (L) Abdali Table 1) |
