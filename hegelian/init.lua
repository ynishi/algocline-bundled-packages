...
---   "Max iterations").
---
--- ### Caller-tunable within the paper range
---
...
local run_input_shape = T.shape({
    ...
    N                 = T.number:is_optional()
        :describe("Max iterations (default: " .. M._defaults.N .. " per Abdali Table 2 \"Max iterations\")"),
    tau_0             = T.number:is_optional()
        :describe("Initial temperature (default: " .. M._defaults.tau_0 .. " per Abdali Table 2 \"Initial temperature\")"),
    tau_a             = T.number:is_optional()
        :describe("Antithesis/opposition temperature (default: " .. M._defaults.tau_a .. " per Abdali Table 2 \"Opposition temperature\")"),
    theta             = T.number:is_optional()
        :describe("Decay constant θ ∈ [0.1, 0.5] (default: " .. M._defaults.theta .. "; implementation choice within the paper's stated range from Table 2)"),
    ...
    thesis_prompt     = T.string:is_optional()
        :describe("Override thesis prompt template (implementation choice — paper specifies role but not wording)"),
    antithesis_prompt = T.string:is_optional()
        :describe("Override antithesis prompt template (implementation choice — paper specifies role but not wording)"),
    synthesis_prompt  = T.string:is_optional()
        :describe("Override synthesis prompt template (implementation choice — paper specifies role but not wording)"),
    system_thesis     = T.string:is_optional():describe("Override thesis system prompt (implementation choice)"),
    system_antithesis = T.string:is_optional():describe("Override antithesis system prompt (implementation choice)"),
    system_synthesis  = T.string:is_optional():describe("Override synthesis system prompt (implementation choice)"),
}, { open = true })
...
-- ops, no LLM call. Default template provenance (implementation choice):
-- see DEFAULT_THESIS_PROMPT.
