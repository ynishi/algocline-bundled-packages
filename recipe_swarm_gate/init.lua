...
---
--- AB-MCTS (Sakana AI 2025, arXiv:2503.04412) explores the
--- (width × depth) reasoning tree with Thompson sampling and is
--- known to lift accuracy when ensembled across diverse seeding
--- prompts. orch_gatephase contributes the Phase-gate discipline
--- (Heitkoetter et al. 2021 style structured verification) so the
--- aggregator's verdict is gate-bounded rather than a free-form pick.
--- The recipe assumes branch outputs are exchangeable conditional on
--- the approach hint; under that assumption the consensus pick maximises
--- the expected best_score over the swarm.
---
--- ## Caveats
---
