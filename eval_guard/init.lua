...
--- independently or combined via `check_all`. N1 (inverse-U scaling) and
--- N5 (Pareto dominance) live in `inverse_u` and `cost_pareto`; this
--- package handles structural checks.
---
--- ## Usage
---
--- ```lua
